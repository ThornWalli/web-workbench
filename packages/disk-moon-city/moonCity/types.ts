...
export const STORAGE_TYPE_TO_RESOURCE: Partial<{
  [key in STORAGE_TYPE]: RESOURCE_TYPE;
}> = {
  [STORAGE_TYPE.CREDITS]: RESOURCE_TYPE.CREDITS,
  [STORAGE_TYPE.MINERAL_ORE]: RESOURCE_TYPE.MINERAL_ORE,
  [STORAGE_TYPE.ENERGY_CELL]: RESOURCE_TYPE.ENERGY_CELL,
  [STORAGE_TYPE.FOOD]: RESOURCE_TYPE.FOOD,
  [STORAGE_TYPE.ENERGY]: RESOURCE_TYPE.ENERGY,
  [STORAGE_TYPE.HUMAN]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.EMPLOYEE]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.SECURITY_SERVICE]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.SOLDIER]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.MERCENARY]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.ENERGY_TRANSFER]: RESOURCE_TYPE.NONE,
  [STORAGE_TYPE.SHIELD_ENERGY]: RESOURCE_TYPE.SHIELD_ENERGY
};

...
export const sfx = {
  text_drawer_write: sfx_text_drawer_write,
  text_drawer_end: sfx_text_drawer_end,
  error: sfx_error,
  button_1_click: sfx_button_1_click,
  button_2_click: sfx_button_2_click,
  button_3_click: sfx_button_3_click,

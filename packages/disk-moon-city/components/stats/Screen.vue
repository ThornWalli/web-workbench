...
import McStatsScreenLastLog from './screen/LastLog.vue';
import McStatsScreenPopulation from './screen/Population.vue';
import McStatsScreenCredits from './screen/Credits.vue';

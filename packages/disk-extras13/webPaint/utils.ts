...
export function getDefaultConfig() {
  return {
    [CONFIG_NAMES.WEB_PAINTING_DISPLAY_BACKGROUND]: '#CCCCCCFF',
    [CONFIG_NAMES.WEB_PAINTING_DISPLAY_FOREGROUND]: '#FFFFFFFF',
    [CONFIG_NAMES.WEB_PAINTING_DISPLAY_GRID_COLOR]: '#00000033',
    [CONFIG_NAMES.WEB_PAINTING_FIT_IMAGE]: true,
    [CONFIG_NAMES.WEB_PAINTING_NATIVE_THEME]: false
  };
}

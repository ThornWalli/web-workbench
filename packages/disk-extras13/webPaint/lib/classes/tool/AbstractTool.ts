import type { UseToolPayload } from '@web-workbench/disk-extras13/webPaint/types/worker.payload';
...
import type { ActionCommandToMainWorker } from '@web-workbench/disk-extras13/webPaint/types/worker.message.main';

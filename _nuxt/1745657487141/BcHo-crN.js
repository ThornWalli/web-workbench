var Y=Object.defineProperty;var G=(t,e,i)=>e in t?Y(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var u=(t,e,i)=>G(t,typeof e!="symbol"?e+"":e,i);import{i as P}from"./2o4skMhU.js";function s(t,e,i,n,l=0){t.fillStyle=n,t.fillRect(Number(e.getAttribute("x"))+i[0],Number(e.getAttribute("y"))+i[1]-l,Number(e.getAttribute("width")),Number(e.getAttribute("height"))+l)}function o(t,e,i,n){if(!(e instanceof SVGPolygonElement))throw new Error("polygon is not an instance of SVGPolygonElement");t.fillStyle=n,t.beginPath(),Array.from(e.points).forEach((l,r)=>{r<1?t.moveTo(l.x+i[0],l.y+i[1]):t.lineTo(l.x+i[0],l.y+i[1])}),t.closePath(),t.fill()}const V=[{test:/^2m/,name:"sharp",selectors:[{selector:"#sharp rect",draw:s,offset:[-8,0]}]},{test:/^2m/,name:"doubleSharp",selectors:[{selector:"#double-sharp rect",draw:s,offset:[-8,0]}]},{test:/^2m/,name:"dot",selectors:[{selector:"#dot",draw:o,offset:[4,0]}]},{test:/^1m/,name:"sharp",selectors:[{selector:"#sharp rect",draw:s,offset:[-4,0]}]},{test:/^1m/,name:"doubleSharp",selectors:[{selector:"#double-sharp rect",draw:s,offset:[-4,0]}]},{test:/^1m/,name:"dot",selectors:[{selector:"#dot",draw:o,offset:[1,0]}]},{test:/^2m/,name:"flat",selectors:[{selector:"#flat-1 rect",draw:s,offset:[-8,0]}]},{test:/^2m/,name:"doubleFlat",selectors:[{selector:"#flat-1 rect",draw:s,offset:[-8,0]},{selector:"#flat-2 rect",draw:s,offset:[-8,0]}]},{test:/^1m/,name:"flat",selectors:[{selector:"#flat-1 rect",draw:s,offset:[-5,0]}]},{test:/^1m/,name:"doubleFlat",selectors:[{selector:"#flat-1 rect",draw:s,offset:[-5,0]},{selector:"#flat-2 rect",draw:s,offset:[-5,0]}]},{name:"flat",selectors:[{selector:"#flat-1 rect",draw:s}]},{name:"doubleFlat",selectors:[{selector:"#flat-1 rect",draw:s},{selector:"#flat-2 rect",draw:s}]},{name:"sharp",selectors:[{selector:"#sharp rect",draw:s}]},{name:"doubleSharp",selectors:[{selector:"#double-sharp rect",draw:(...t)=>s(...t)}]},{name:"dot",selectors:[{selector:"#dot",draw:o}]}],q=[{time:[/^1m/],offset:[0,3],selectors:[{selector:"#whole-pause",draw:s}]},{time:[/^2m/],offset:[0,3],selectors:[{selector:"#double-pause",draw:s}]},{time:[/^2[nt]/],offset:[0,7],selectors:[{selector:"#half-pause",draw:s}]},{time:[/^4[nt]/],offset:[0,0],selectors:[{selector:"#divide-pause-line-0",draw:s},{selector:"#divide-pause-line-1",draw:o}]},{time:[/^8[nt]/],selectors:[{selector:"#divide-pause-line-0",draw:s},{selector:"#divide-pause-line-1",draw:o},{selector:"#divide-pause-line-2",draw:o}]},{time:[/^16[nt]/],offset:[0,0],selectors:[{selector:"#divide-pause-line-0",draw:s},{selector:"#divide-pause-line-1",draw:o},{selector:"#divide-pause-line-2",draw:o,color:"black"},{selector:"#divide-pause-line-3",draw:o,color:"black"}]},{time:[/^32[nt]/],offset:[0,0],selectors:[{selector:"#divide-pause-line-0",draw:s},{selector:"#divide-pause-line-1",draw:o},{selector:"#divide-pause-line-2",draw:o},{selector:"#divide-pause-line-3",draw:o},{selector:"#divide-pause-line-4",draw:o}]}],f={PRIMARY:"primary",SECONDARY:"secondary"},j=[{time:[/^1m/],selectors:[{selector:"#whole-background",draw:o},{selector:"#whole-foreground",draw:o,color:f.SECONDARY}]},{time:[/^2m/],selectors:[{selector:"#whole-background",draw:o},{selector:"#whole-foreground",draw:o,color:f.SECONDARY},{selector:"#whole-double rect",draw:s}]},{time:[/^2[nt]/],selectors:[{selector:"#divide-background",draw:o},{selector:"#divide-foreground",draw:o,color:f.SECONDARY},{selector:"#divide-line",draw:s,autoHeight:!0}]},{time:[/^4[nt]/],selectors:[{selector:"#divide-background",draw:o},{selector:"#divide-line",draw:s,autoHeight:!0}]},{time:[/^8[nt]/],selectors:[{selector:"#divide-background",draw:o},{selector:"#divide-line",draw:s,autoHeight:!0}]},{time:[/^16[nt]/],selectors:[{selector:"#divide-background",draw:o},{selector:"#divide-line",draw:s,autoHeight:!0}]},{time:[/^32[nt]/],selectors:[{selector:"#divide-background",draw:o},{selector:"#divide-line",draw:s,autoHeight:!0}]}],B=`<?xml version="1.0" encoding="utf-8"?>
...
`,R=100,X=3;class K{constructor(e){this.canvas=e,this.firstPixel=L(this.canvas)}}function L(t){const{data:e}=t.getContext("2d").getImageData(0,0,t.width,t.height);for(let i=0;i<e.length;i+=4)if(e[i+3]===255){const n=Math.floor(i/4/t.width),l=i/4-n*t.width;return P(l,n)}}const W=new Map;class Q{constructor(e){u(this,"localCache",!1);u(this,"_cache",new Map);u(this,"colors",{background:"#000000",foreground:"#000000"});const{localCache:i}=e||{};this.localCache=i!==void 0?i:!1,this.queue=Promise.resolve();const n=new DOMParser;this.svgNode=n.parseFromString(B,"image/svg+xml").querySelector("svg");const{width:l,height:r}=this.svgNode.viewBox.baseVal;this.dimension=P(l,r),this.canvas=new OffscreenCanvas(this.dimension.x+R,this.dimension.y+R),this.canvasContext=this.canvas.getContext("2d",{willReadFrequently:!0}),this.canvasContext.imageSmoothingEnabled=!1}get cache(){return this.localCache?this._cache:W}render(e,i,n=0){const{colors:l}=i||{},r={background:"#0055aa",foreground:"#000000",...l},h=[e.getName(),e.getTime(),Object.values(r).join("_"),n].join("_");return this.cache.has(h)?Promise.resolve(this.cache.get(h)):this.queue=this.queue.then(()=>{var F,C,E,N,k;const a=this.svgNode,c=this.canvasContext.canvas,d=this.canvasContext;d.clearRect(0,0,c.width,c.height);const w=(e.isPause?q:j).find(_=>_.time.find(T=>T.test(e.time.toString())));w&&g(a,d,w.selectors,r,n),(F=e.time)!=null&&F.dot&&g(a,d,p("dot",e),r,n),(C=e.note)!=null&&C.flat&&g(a,d,p("flat",e),r,n),(E=e.note)!=null&&E.doubleFlat&&g(a,d,p("doubleFlat",e),r,n),(N=e.note)!=null&&N.sharp&&g(a,d,p("sharp",e),r,n),(k=e.note)!=null&&k.doubleSharp&&g(a,d,p("doubleSharp",e),r,n);const{x:A,y:O,width:I,height:M}=z(d);let m=0,v=M+X;w.offset&&(w.offset[1]<0?(m=Math.abs(m),v+=Math.abs(m)):v+=w.offset[1]);const y=new OffscreenCanvas(I,v),b=y.getContext("2d");b.imageSmoothingEnabled=!1,b.drawImage(c,A,O,y.width,y.height,0,0,y.width,y.height);const S=new K(y);return this.cache.set(h,S),S})}}function z(t){const e=t.canvas,i=t.getImageData(0,0,e.width,e.height).data;let n=1/0,l=-1/0,r=1/0,h=-1/0;for(let a=0;a<i.length;a+=4){const c=Math.floor(a/4)%e.width,d=Math.floor(a/4/e.width);i[a+3]&&(c<n?n=c:c>l&&(l=c),d<r?r=d:d>h&&(h=d))}return{x:n,y:r,width:l-n+1,height:h-r+1}}function g(t,e,i,n,l=0){i.forEach(({selector:r,draw:h,color:a,offset:c,autoHeight:d})=>{c=[...c||[0,0]],c[0]+=(e.canvas.width-26)/2,c[1]+=l,Array.from(t.querySelectorAll(r)).forEach(x=>{h(e,x,c,n[String(a||f.PRIMARY)],d&&l||0)})})}function p(t,e){var i;return(i=V.find(n=>{var l;return n.name===t&&(((l=n.test)==null?void 0:l.test(e.time.toString()))||!n.test)}))==null?void 0:i.selectors}export{Q as N,X as S,B as a};

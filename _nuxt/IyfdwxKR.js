import{g as Xn,y as ee,z as te,A as J,a as h,B as y,G as Je,H as Zt,I as Qn,J as Zn,o as _,_ as en,K as tn,M as ei,N as ti,O as ni,S as de,P as ii,F as et,E as tt,L as ri,Q as nn,R as si,T as oi,U as ai,V as ci,e as St,C as bt,r as Nt,W as li}from"./DXdLLGcu.js";import{a as nt}from"./D4lI5vpz.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ae(n){var e;const t=n.auth,i=await n.getIdToken(),r=await C(n,Pe(t,{idToken:i}));l(r==null?void 0:r.users.length,t,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?dn(s.providerUserInfo):[],a=Pi(n.providerData,o),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=c?u:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Xe(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function ki(n){const e=h(n);await ae(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Pi(n,e){return[...n.filter(i=>!e.some(r=>r.providerId===i.providerId)),...e]}function dn(n){return n.map(e=>{var{providerId:t}=e,i=nt(e,["providerId"]);return{providerId:t,uid:i.rawId||"",displayName:i.displayName||null,email:i.email||null,phoneNumber:i.phoneNumber||null,photoURL:i.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(gn(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(pn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(In(e))return"Blackberry";if(vn(e))return"Webos";if(fn(e))return"Safari";if((e.includes("chrome/")||mn(e))&&!e.includes("edge/"))return"Chrome";if(_n(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function pn(n=y()){return/firefox\//i.test(n)}function fn(n=y()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function mn(n=y()){return/crios\//i.test(n)}function gn(n=y()){return/iemobile/i.test(n)}function _n(n=y()){return/android/i.test(n)}function In(n=y()){return/blackberry/i.test(n)}function vn(n=y()){return/webos/i.test(n)}function at(n=y()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ni(n=y()){var e;return at(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Ci(){return ti()&&document.documentMode===10}function En(n=y()){return at(n)||_n(n)||vn(n)||In(n)||/windows phone/i.test(n)||gn(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(n,e=[]){let t;switch(n){case"Browser":t=Vt(y());break;case"Worker":t=`${Vt(y())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${de}/${i}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function go(n,e){const t=h(n);await De(!0,t,e);const{providerUserInfo:i}=await wi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=bn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function lt(n,e,t=!1){const i=await C(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function De(n,e,t){await ae(e);const i=bn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";l(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rr(n){var e,t;if(!n)return null;const{providerId:i}=n,r=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},s=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&(n!=null&&n.idToken)){const o=(t=(e=Ce(n.idToken))===null||e===void 0?void 0:e.firebase)===null||t===void 0?void 0:t.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new B(s,a)}}if(!i)return null;switch(i){case"facebook.com":return new kr(s,r);case"github.com":return new Pr(s,r);case"google.com":return new Sr(s,r);case"twitter.com":return new br(s,r,n.screenName||null);case"custom":case"anonymous":return new B(s,null);default:return new B(s,i,r)}}class B{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class Dn extends B{constructor(e,t,i,r){super(e,t,i),this.username=r}}class kr extends B{constructor(e,t){super(e,"facebook.com",t)}}class Pr extends Dn{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class Sr extends B{constructor(e,t){super(e,"google.com",t)}}class br extends Dn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Do(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:Rr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

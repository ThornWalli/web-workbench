import{g as D,F as _,a as k,_ as R,a0 as L,H as F,I as U,J as x,e as $,C as M,r as v,o as H}from"./BAgKhQxM.js";/**
 * @license
...
`);s=p.pop()||"";for(const h of p)h.trim()&&i(h.trim(),a);return l()}catch(u){const c=u instanceof d?u:y(0,null);a.error(c),n(c)}}},cancel(){return e.cancel()}})}const b="@firebase/functions",C="0.12.9";/**
 * @license

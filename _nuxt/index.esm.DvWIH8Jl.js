import{X as lr}from"./index.pPIpAzmo.js";import{L as ar,I as f,J as _e,K as B,l as F,e as cr,M as hr,i as ur,N as dr,C as Jt,w as fr,O as b,P as St,Q as ut,H as Zt,R as Y,T as pe,f as _r,r as ni,U as ii,V as vn,W as pr,X as mr,Y as gr,Z as Wi,$ as yr,a0 as vr,x as Ui,y as Cr,q as Er,a1 as wr,a2 as Tr,a3 as Ir,a4 as Xe,S as Sr}from"./index.esm2017.DKkwCfLL.js";import"./entry.CpSyzEib.js";import"./index.CTgiTu_k.js";var si={};const ri="@firebase/database",oi="1.0.3";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Y(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hi=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Nr(e)}}catch{}return new Rr},de=Hi("localStorage"),en=Hi("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wr{constructor(e,t){this.appName_=e,this.appCheckProvider=t,this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(i=>this.appCheck=i)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){O(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur{constructor(e,t,i){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(x("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',O(e)}}class Se{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Se.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vr{constructor(){this.counters_={}}incrementCounter(e,t=1){Y(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Tr(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt={},Yt={};function wn(n){const e=n.toString();return qt[e]||(qt[e]=new Vr),qt[e]}function Hr(n,e){const t=n.toString();return Yt[t]||(Yt[t]=e()),Yt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci="start",Qr="close",qr="pLPCommand",Yr="pRTLPCB",rs="id",os="pw",ls="ser",Kr="cb",zr="seg",jr="ts",$r="d",Xr="dframe",as=1870,cs=30,Jr=as-cs,Zr=25e3,eo=3e4;class te{constructor(e,t,i,s,r,o,l){this.connId=e,this.repoInfo=t,this.applicationId=i,this.appCheckToken=s,this.authToken=r,this.transportSessionId=o,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Ze(e),this.stats_=wn(t),this.urlFn=a=>(this.appCheckToken&&(a[nn]=this.appCheckToken),ss(t,ns,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new Gr(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(eo)),Pr(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Tn((...r)=>{const[o,l,a,c,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===ci)this.id=l,this.password=a;else if(o===Qr)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,l]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,l)},()=>{this.onClosed_()},this.urlFn);const i={};i[ci]="t",i[ls]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[Kr]=this.scriptTagHolder.uniqueCallbackIdentifier),i[zi]=En,this.transportSessionId&&(i[ji]=this.transportSessionId),this.lastSessionId&&(i[Zi]=this.lastSessionId),this.applicationId&&(i[es]=this.applicationId),this.appCheckToken&&(i[nn]=this.appCheckToken),typeof location<"u"&&location.hostname&&Ji.test(location.hostname)&&(i[$i]=Xi);const s=this.urlFn(i);this.log_("Connecting via long-poll to "+s),this.scriptTagHolder.addTag(s,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){te.forceAllow_=!0}static forceDisallow(){te.forceDisallow_=!0}static isAvailable(){return te.forceAllow_?!0:!te.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!xr()&&!Ar()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=b(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const i=Ir(t),s=Yi(i,Jr);for(let r=0;r<s.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,s.length,s[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const i={};i[Xr]="t",i[rs]=e,i[os]=t,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=b(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Tn{constructor(e,t,i,s){this.onDisconnect=i,this.urlFn=s,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Gi(),window[qr+this.uniqueCallbackIdentifier]=e,window[Yr+this.uniqueCallbackIdentifier]=t,this.myIFrame=Tn.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(l){x("frame writing exception"),l.stack&&x(l.stack),x(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||x("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[rs]=this.myID,e[os]=this.myPW,e[ls]=this.currentSerial;let t=this.urlFn(e),i="",s=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+cs+i.length<=as;){const o=this.pendingSegs.shift();i=i+"&"+zr+s+"="+o.seg+"&"+jr+s+"="+o.ts+"&"+$r+s+"="+o.d,s++}return t=t+i,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,i){this.pendingSegs.push({seg:e,ts:t,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const i=()=>{this.outstandingRequests.delete(t),this.newRequest_()},s=setTimeout(i,Math.floor(Zr)),r=()=>{clearTimeout(s),i()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const s=i.readyState;(!s||s==="loaded"||s==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),t())},i.onerror=()=>{x("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft extends us{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Ui()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new ft}getInitialEvent(e){return f(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn extends us{constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}static getInstance(){return new Nn}getInitialEvent(e){return f(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wo(n,e){return ve(n.name,e.name)}function Rn(n,e){return ve(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=Math.log(2);class bo{constructor(e){const t=r=>parseInt(Math.log(r)/Ro,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const _t=function(n,e,t,i){n.sort(e);const s=function(a,c){const u=c-a;let h,d;if(u===0)return null;if(u===1)return h=n[a],d=t?t(h):h,new k(d,h.node,k.BLACK,null,null);{const _=parseInt(u/2,10)+a,p=s(a,_),w=s(_+1,c);return h=n[_],d=t?t(h):h,new k(d,h.node,k.BLACK,p,w)}},r=function(a){let c=null,u=null,h=n.length;const d=function(p,w){const D=h-p,we=h;h-=p;const at=s(D+1,we),Qt=n[D],or=t?t(Qt):Qt;_(new k(or,Qt.node,w,null,at))},_=function(p){c?(c.left=p,c=p):(u=p,c=p)};for(let p=0;p<a.count;++p){const w=a.nextBitIsOne(),D=Math.pow(2,a.count-(p+1));w?d(D,k.BLACK):(d(D,k.BLACK),d(D,k.RED))}return u},o=new bo(n.length),l=r(o);return new L(i||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ko=!0;function R(n,e=null){if(n===null)return m.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new P(t,R(e))}if(!(n instanceof Array)&&ko){const t=[];let i=!1;if(A(n,(o,l)=>{if(o.substring(0,1)!=="."){const a=R(l);a.isEmpty()||(i=i||!a.getPriority().isEmpty(),t.push(new v(o,a)))}}),t.length===0)return m.EMPTY_NODE;const r=_t(t,wo,o=>o.name,Rn);if(i){const o=_t(t,S.getCompare());return new m(r,R(e),new Z({".priority":o},{".priority":S}))}else return new m(r,R(e),Z.Default)}else{let t=m.EMPTY_NODE;return A(n,(i,s)=>{if(Y(n,i)&&i.substring(0,1)!=="."){const r=R(s);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(i,r))}}),t.updatePriority(R(e))}}Io(R);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo extends Rt{compare(e,t){const i=e.node.compareTo(t.node);return i===0?ve(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return v.MIN}maxPost(){return v.MAX}makePost(e,t){const i=R(e);return new v(t,i)}toString(){return".value"}}const Pn=new xo;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vs(n){return{type:"value",snapshotNode:n}}function Re(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function qe(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Ye(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Ao(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uo{constructor(){this.rootNode_=m.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&A(this.last_,(i,s)=>{t[i]=t[i]-s}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti=10*1e3,Ho=30*1e3,Go=5*60*1e3;class Qo{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Vo(e);const i=Ti+(Ho-Ti)*Math.random();Be(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;A(e,(s,r)=>{r>0&&Y(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Be(this.reportStats_.bind(this),Math.floor(Math.random()*2*Go))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Yo(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Ao(o.childName,o.snapshotNode))}),Ue(n,s,"child_removed",e,i,t),Ue(n,s,"child_added",e,i,t),Ue(n,s,"child_moved",r,i,t),Ue(n,s,"child_changed",e,i,t),Ue(n,s,"value",e,i,t),s}function Ue(n,e,t,i,s,r){const o=i.filter(l=>l.type===t);o.sort((l,a)=>zo(n,l,a)),o.forEach(l=>{const a=Ko(n,l,r);s.forEach(c=>{c.respondsTo(l.type)&&e.push(c.createEvent(a,n.query_))})})}function Ko(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function zo(n,e,t){if(e.childName==null||t.childName==null)throw Xe("Should only compare child_ events.");const i=new v(e.childName,e.snapshotNode),s=new v(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(n,e){return Ss(e,n)}function $o(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=He(n.visibleWrites,e,t)),n.lastWriteId=i}function Xo(n,e,t,i){f(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=cn(n.visibleWrites,e,t),n.lastWriteId=i}function Jo(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function Zo(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&el(l,i.path)?s=!1:H(i.path,l.path)&&(r=!0)),o--}if(s){if(r)return tl(n),!0;if(i.snap)n.visibleWrites=Ii(n.visibleWrites,i.path);else{const l=i.children;A(l,a=>{n.visibleWrites=Ii(n.visibleWrites,N(i.path,a))})}return!0}else return!1}function el(n,e){if(n.snap)return H(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&H(N(n.path,t),e))return!0;return!1}function tl(n){n.visibleWrites=ws(n.allWrites,nl,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function nl(n){return n.visible}function ws(n,e,t){let i=q.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let l;if(r.snap)H(t,o)?(l=M(t,o),i=He(i,l,r.snap)):H(o,t)&&(l=M(o,t),i=He(i,C(),r.snap.getChild(l)));else if(r.children){if(H(t,o))l=M(t,o),i=cn(i,l,r.children);else if(H(o,t))if(l=M(o,t),y(l))i=cn(i,C(),r.children);else{const a=pe(r.children,g(l));if(a){const c=a.getChild(T(l));i=He(i,C(),c)}}}else throw Xe("WriteRecord should have .snap or .children")}}return i}function Ts(n,e,t,i,s){if(!i&&!s){const r=Ce(n.visibleWrites,e);if(r!=null)return r;{const o=ie(n.visibleWrites,e);if(un(o))return t;if(t==null&&!hn(o,C()))return null;{const l=t||m.EMPTY_NODE;return Pe(o,l)}}}else{const r=ie(n.visibleWrites,e);if(!s&&un(r))return t;if(!s&&t==null&&!hn(r,C()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(H(c.path,e)||H(e,c.path))},l=ws(n.allWrites,o,e),a=t||m.EMPTY_NODE;return Pe(l,a)}}}function il(n,e,t){let i=m.EMPTY_NODE;const s=Ce(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(S,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=ie(n.visibleWrites,e);return t.forEachChild(S,(o,l)=>{const a=Pe(ie(r,new E(o)),l);i=i.updateImmediateChild(o,a)}),Si(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ie(n.visibleWrites,e);return Si(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function sl(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=N(e,t);if(hn(n.visibleWrites,r))return null;{const o=ie(n.visibleWrites,r);return un(o)?s.getChild(t):Pe(o,s.getChild(t))}}function rl(n,e,t,i){const s=N(e,t),r=Ce(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=ie(n.visibleWrites,s);return Pe(o,i.getNode().getImmediateChild(t))}else return null}function ol(n,e){return Ce(n.visibleWrites,e)}function ll(n,e,t,i,s,r,o){let l;const a=ie(n.visibleWrites,e),c=Ce(a,C());if(c!=null)l=c;else if(t!=null)l=Pe(a,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(i,o):l.getIteratorFrom(i,o);let _=d.getNext();for(;_&&u.length<s;)h(_,i)!==0&&u.push(_),_=d.getNext();return u}else return[]}function al(){return{visibleWrites:q.empty(),allWrites:[],lastWriteId:-1}}function vt(n,e,t,i){return Ts(n.writeTree,n.treePath,e,t,i)}function Mn(n,e){return il(n.writeTree,n.treePath,e)}function Ni(n,e,t,i){return sl(n.writeTree,n.treePath,e,t,i)}function Ct(n,e){return ol(n.writeTree,N(n.treePath,e))}function cl(n,e,t,i,s,r){return ll(n.writeTree,n.treePath,e,t,i,s,r)}function Ln(n,e,t){return rl(n.writeTree,n.treePath,e,t)}function Is(n,e){return Ss(N(n.treePath,e),n.writeTree)}function Ss(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ul{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Ns=new ul;class Fn{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new le(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ln(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ge(this.viewCache_),r=cl(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cl{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const i=this.query_._queryParams,s=new kn(i.getIndex()),r=Oo(i);this.processor_=dl(r);const o=t.serverCache,l=t.eventCache,a=s.updateFullNode(m.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(m.EMPTY_NODE,l.getNode(),null),u=new le(a,o.isFullyInitialized(),s.filtersNodes()),h=new le(c,l.isFullyInitialized(),r.filtersNodes());this.viewCache_=Pt(h,u),this.eventGenerator_=new qo(this.query_)}get query(){return this.query_}}function El(n){return n.viewCache_.serverCache.getNode()}function wl(n){return yt(n.viewCache_)}function Tl(n,e){const t=ge(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!y(e)&&!t.getImmediateChild(g(e)).isEmpty())?t.getChild(e):null}function Pi(n){return n.eventRegistrations_.length===0}function Il(n,e){n.eventRegistrations_.push(e)}function ki(n,e,t){const i=[];if(t){f(e==null,"A cancel should cancel all event registrations.");const s=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,s);o&&i.push(o)})}if(e){let s=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))s.push(o);else if(e.hasAnyCallback()){s=s.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=s}else n.eventRegistrations_=[];return i}function xi(n,e,t,i){e.type===Q.MERGE&&e.source.queryId!==null&&(f(ge(n.viewCache_),"We should always have a full cache before handling merges"),f(yt(n.viewCache_),"Missing event cache, even though we have a server cache"));const s=n.viewCache_,r=_l(n.processor_,s,e,t,i);return fl(n.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,bs(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Sl(n,e){const t=n.viewCache_.eventCache,i=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(S,(r,o)=>{i.push(Re(r,o))}),t.isFullyInitialized()&&i.push(vs(t.getNode())),bs(n,i,t.getNode(),e)}function bs(n,e,t,i){const s=i?[i]:n.eventRegistrations_;return Yo(n.eventGenerator_,e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wt;class Ps{constructor(){this.views=new Map}}function Nl(n){f(!wt,"__referenceConstructor has already been defined"),wt=n}function Rl(){return f(wt,"Reference.ts has not been loaded"),wt}function bl(n){return n.views.size===0}function Wn(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return f(r!=null,"SyncTree gave us an op for an invalid query."),xi(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(xi(o,e,t,i));return r}}function ks(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let l=vt(t,s?i:null),a=!1;l?a=!0:i instanceof m?(l=Mn(t,i),a=!1):(l=m.EMPTY_NODE,a=!1);const c=Pt(new le(l,a,!1),new le(i,s,!1));return new Cl(e,c)}return o}function Pl(n,e,t,i,s,r){const o=ks(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Il(o,t),Sl(o,t)}function kl(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const l=ae(n);if(s==="default")for(const[a,c]of n.views.entries())o=o.concat(ki(c,t,i)),Pi(c)&&(n.views.delete(a),c.query._queryParams.loadsAllData()||r.push(c.query));else{const a=n.views.get(s);a&&(o=o.concat(ki(a,t,i)),Pi(a)&&(n.views.delete(s),a.query._queryParams.loadsAllData()||r.push(a.query)))}return l&&!ae(n)&&r.push(new(Rl())(e._repo,e._path)),{removed:r,events:o}}function xs(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function se(n,e){let t=null;for(const i of n.views.values())t=t||Tl(i,e);return t}function As(n,e){if(e._queryParams.loadsAllData())return xt(n);{const i=e._queryIdentifier;return n.views.get(i)}}function Ds(n,e){return As(n,e)!=null}function ae(n){return xt(n)!=null}function xt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tt;function xl(n){f(!Tt,"__referenceConstructor has already been defined"),Tt=n}function Al(){return f(Tt,"Reference.ts has not been loaded"),Tt}let Dl=1;class Ai{constructor(e){this.listenProvider_=e,this.syncPointTree_=new I(null),this.pendingWriteTree_=al(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Un(n,e,t,i,s){return $o(n.pendingWriteTree_,e,t,i,s),s?Oe(n,new me(An(),e,t)):[]}function Ol(n,e,t,i){Xo(n.pendingWriteTree_,e,t,i);const s=I.fromObject(t);return Oe(n,new be(An(),e,s))}function ne(n,e,t=!1){const i=Jo(n.pendingWriteTree_,e);if(Zo(n.pendingWriteTree_,e)){let r=new I(null);return i.snap!=null?r=r.set(C(),!0):A(i.children,o=>{r=r.set(new E(o),!0)}),Oe(n,new gt(i.path,r,t))}else return[]}function tt(n,e,t){return Oe(n,new me(Dn(),e,t))}function Ml(n,e,t){const i=I.fromObject(t);return Oe(n,new be(Dn(),e,i))}function Ll(n,e){return Oe(n,new ze(Dn(),e))}function Fl(n,e,t){const i=Bn(n,t);if(i){const s=Vn(i),r=s.path,o=s.queryId,l=M(r,e),a=new ze(On(o),l);return Hn(n,r,a)}else return[]}function It(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Ds(o,e))){const a=kl(o,e,t,i);bl(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!s){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,_)=>ae(_));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=Bl(d);for(let p=0;p<_.length;++p){const w=_[p],D=w.query,we=Fs(n,w);n.listenProvider_.startListening(Ge(D),je(n,D),we.hashFn,we.onComplete)}}}!h&&c.length>0&&!i&&(u?n.listenProvider_.stopListening(Ge(e),null):c.forEach(d=>{const _=n.queryToTagMap.get(Dt(d));n.listenProvider_.stopListening(Ge(d),_)}))}Vl(n,c)}return l}function Os(n,e,t,i){const s=Bn(n,i);if(s!=null){const r=Vn(s),o=r.path,l=r.queryId,a=M(o,e),c=new me(On(l),a,t);return Hn(n,o,c)}else return[]}function Wl(n,e,t,i){const s=Bn(n,i);if(s){const r=Vn(s),o=r.path,l=r.queryId,a=M(o,e),c=I.fromObject(t),u=new be(On(l),a,c);return Hn(n,o,u)}else return[]}function _n(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,_)=>{const p=M(d,s);r=r||se(_,p),o=o||ae(_)});let l=n.syncPointTree_.get(s);l?(o=o||ae(l),r=r||se(l,C())):(l=new Ps,n.syncPointTree_=n.syncPointTree_.set(s,l));let a;r!=null?a=!0:(a=!1,r=m.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((_,p)=>{const w=se(p,C());w&&(r=r.updateImmediateChild(_,w))}));const c=Ds(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=Dt(e);f(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=Hl();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const u=kt(n.pendingWriteTree_,s);let h=Pl(l,e,t,u,r,a);if(!c&&!o&&!i){const d=As(l,e);h=h.concat(Gl(n,e,d))}return h}function At(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const a=M(o,e),c=se(l,a);if(c)return c});return Ts(s,e,r,t,!0)}function Ul(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=M(c,t);i=i||se(u,h)});let s=n.syncPointTree_.get(t);s?i=i||se(s,C()):(s=new Ps,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new le(i,!0,!1):null,l=kt(n.pendingWriteTree_,e._path),a=ks(s,e,l,r?o.getNode():m.EMPTY_NODE,r);return wl(a)}function Oe(n,e){return Ms(e,n.syncPointTree_,null,kt(n.pendingWriteTree_,C()))}function Ms(n,e,t,i){if(y(n.path))return Ls(n,e,t,i);{const s=e.get(C());t==null&&s!=null&&(t=se(s,C()));let r=[];const o=g(n.path),l=n.operationForChild(o),a=e.children.get(o);if(a&&l){const c=t?t.getImmediateChild(o):null,u=Is(i,o);r=r.concat(Ms(l,a,c,u))}return s&&(r=r.concat(Wn(s,n,i,t))),r}}function Ls(n,e,t,i){const s=e.get(C());t==null&&s!=null&&(t=se(s,C()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=t?t.getImmediateChild(o):null,c=Is(i,o),u=n.operationForChild(o);u&&(r=r.concat(Ls(u,l,a,c)))}),s&&(r=r.concat(Wn(s,n,i,t))),r}function Fs(n,e){const t=e.query,i=je(n,t);return{hashFn:()=>(El(e)||m.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Fl(n,t._path,i):Ll(n,t._path);{const r=Dr(s,t);return It(n,t,null,r)}}}}function je(n,e){const t=Dt(e);return n.queryToTagMap.get(t)}function Dt(n){return n._path.toString()+"$"+n._queryIdentifier}function Bn(n,e){return n.tagToQueryMap.get(e)}function Vn(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new E(n.substr(0,e))}}function Hn(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=kt(n.pendingWriteTree_,e);return Wn(i,t,s,null)}function Bl(n){return n.fold((e,t,i)=>{if(t&&ae(t))return[xt(t)];{let s=[];return t&&(s=xs(t)),A(i,(r,o)=>{s=s.concat(o)}),s}})}function Ge(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Al())(n._repo,n._path):n}function Vl(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=Dt(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function Hl(){return Dl++}function Gl(n,e,t){const i=e._path,s=je(n,e),r=Fs(n,t),o=n.listenProvider_.startListening(Ge(e),s,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(i);if(s)f(!ae(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,h)=>{if(!y(c)&&u&&ae(u))return[xt(u).query];{let d=[];return u&&(d=d.concat(xs(u).map(_=>_.query))),A(h,(_,p)=>{d=d.concat(p)}),d}});for(let c=0;c<a.length;++c){const u=a[c];n.listenProvider_.stopListening(Ge(u),je(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Gn(t)}node(){return this.node_}}class Qn{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=N(this.path_,e);return new Qn(this.syncTree_,t)}node(){return At(this.syncTree_,this.path_)}}const Ql=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Di=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return ql(n[".sv"],e,t);if(typeof n[".sv"]=="object")return Yl(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},ql=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},Yl=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const i=n.increment;typeof i!="number"&&f(!1,"Unexpected increment value: "+i);const s=e.node();if(f(s!==null&&typeof s<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const o=s.getValue();return typeof o!="number"?i:o+i},Ws=function(n,e,t,i){return Yn(e,new Qn(t,n),i)},qn=function(n,e,t){return Yn(n,new Gn(e),t)};function Yn(n,e,t){const i=n.getPriority().val(),s=Di(i,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,l=Di(o.getValue(),e,t);return l!==o.getValue()||s!==o.getPriority().val()?new P(l,R(s)):n}else{const o=n;return r=o,s!==o.getPriority().val()&&(r=r.updatePriority(new P(s))),o.forEachChild(S,(l,a)=>{const c=Yn(a,e.getImmediateChild(l),t);c!==a&&(r=r.updateImmediateChild(l,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $l=/[\[\].#$\/\u0000-\u001F\u007F]/,Xl=/[\[\].#$\u0000-\u001F\u007F]/,$t=10*1024*1024,Lt=function(n){return typeof n=="string"&&n.length!==0&&!$l.test(n)},Vs=function(n){return typeof n=="string"&&n.length!==0&&!Xl.test(n)},Jl=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Vs(n)},$e=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Nt(n)||n&&typeof n=="object"&&Y(n,".sv")},J=function(n,e,t,i){i&&e===void 0||it(_e(n,"value"),e,t)},it=function(n,e,t){const i=t instanceof E?new _o(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+ue(i));if(typeof e=="function")throw new Error(n+"contains a function "+ue(i)+" with contents = "+e.toString());if(Nt(e))throw new Error(n+"contains "+e.toString()+" "+ue(i));if(typeof e=="string"&&e.length>$t/3&&St(e)>$t)throw new Error(n+"contains a string greater than "+$t+" utf8 bytes "+ue(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(A(e,(o,l)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Lt(o)))throw new Error(n+" contains an invalid key ("+o+") "+ue(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);po(i,o),it(n,l,i),mo(i)}),s&&r)throw new Error(n+' contains ".value" child '+ue(i)+" in addition to actual children.")}},Zl=function(n,e){let t,i;for(t=0;t<e.length;t++){i=e[t];const r=Qe(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Lt(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(fo);let s=null;for(t=0;t<e.length;t++){if(i=e[t],s!==null&&H(s,i))throw new Error(n+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Hs=function(n,e,t,i){if(i&&e===void 0)return;const s=_e(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];A(e,(o,l)=>{const a=new E(o);if(it(s,l,N(t,a)),In(a)===".priority"&&!$e(l))throw new Error(s+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(a)}),Zl(s,r)},jn=function(n,e,t){if(!(t&&e===void 0)){if(Nt(e))throw new Error(_e(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!$e(e))throw new Error(_e(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")}},st=function(n,e,t,i){if(!(i&&t===void 0)&&!Lt(t))throw new Error(_e(n,e)+'was an invalid key = "'+t+`".  Firebase keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]").`)},$n=function(n,e,t,i){if(!(i&&t===void 0)&&!Vs(t))throw new Error(_e(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},ea=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),$n(n,e,t,i)},j=function(n,e){if(g(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Gs=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Lt(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Jl(t))throw new Error(_e(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ta{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ft(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Sn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function Qs(n,e,t){Ft(n,t),qs(n,i=>Sn(i,e))}function W(n,e,t){Ft(n,t),qs(n,i=>H(i,e)||H(e,i))}function qs(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(na(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function na(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();fe&&x("event: "+t.toString()),Ae(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ya(n){let e="";const t=n.split("/");for(let i=0;i<t.length;i++)if(t[i].length>0){let s=t[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function va(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const i=t.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):O(`Invalid query segment '${t}' in query '${n}'`)}return e}const gn=function(n,e){const t=Ca(n),i=t.namespace;t.domain==="firebase.com"&&X(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&t.domain!=="localhost"&&X("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||br();const s=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new is(t.host,t.secure,i,s,e,"",i!==t.subdomain),path:new E(t.pathString)}},Ca=function(n){let e="",t="",i="",s="",r="",o=!0,l="https",a=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(l=n.substring(0,c-1),n=n.substring(c+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(s=ya(n.substring(u,h)));const d=va(n.substring(Math.min(n.length,h)));c=e.indexOf(":"),c>=0?(o=l==="https"||l==="wss",a=parseInt(e.substring(c+1),10)):c=e.length;const _=e.slice(0,c);if(_.toLowerCase()==="localhost")t="localhost";else if(_.split(".").length<=2)t=_;else{const p=e.indexOf(".");i=e.substring(0,p).toLowerCase(),t=e.substring(p+1),r=i}"ns"in d&&(r=d.ns)}return{host:e,port:a,domain:t,subdomain:i,secure:o,scheme:l,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wa{constructor(e,t){this._repo=e,this._path=t}cancel(){const e=new B;return ha(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){j("OnDisconnect.remove",this._path);const e=new B;return Li(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){j("OnDisconnect.set",this._path),J("OnDisconnect.set",e,this._path,!1);const t=new B;return Li(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}setWithPriority(e,t){j("OnDisconnect.setWithPriority",this._path),J("OnDisconnect.setWithPriority",e,this._path,!1),jn("OnDisconnect.setWithPriority",t,!1);const i=new B;return ua(this._repo,this._path,e,t,i.wrapCallback(()=>{})),i.promise}update(e){j("OnDisconnect.update",this._path),Hs("OnDisconnect.update",e,this._path,!1);const t=new B;return da(this._repo,this._path,e,t.wrapCallback(()=>{})),t.promise}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return y(this._path)?null:In(this._path)}get ref(){return new K(this._repo,this._path)}get _queryIdentifier(){const e=wi(this._queryParams),t=Cn(e);return t==="{}"?"default":t}get _queryObject(){return wi(this._queryParams)}isEqual(e){if(e=F(e),!(e instanceof U))return!1;const t=this._repo===e._repo,i=Sn(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+uo(this._path)}}function Vt(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function he(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===$){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",s="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==re)throw new Error(i);if(typeof e!="string")throw new Error(s)}if(n.hasEnd()){if(n.getIndexEndName()!==ee)throw new Error(i);if(typeof t!="string")throw new Error(s)}}else if(n.getIndex()===S){if(e!=null&&!$e(e)||t!=null&&!$e(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(f(n.getIndex()instanceof bn||n.getIndex()===Pn,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function Ht(n){if(n.hasStart()&&n.hasEnd()&&n.hasLimit()&&!n.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class K extends U{constructor(e,t){super(e,t,new xn,!1)}get parent(){const e=ds(this._path);return e===null?null:new K(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ye{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new E(e),i=xe(this.ref,e);return new ye(this._node.getChild(t),i,S)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new ye(s,xe(this.ref,i),S)))}hasChild(e){const t=new E(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ta(n,e){return n=F(n),n._checkNotDeleted("ref"),e!==void 0?xe(n._root,e):n._root}function za(n,e){n=F(n),n._checkNotDeleted("refFromURL");const t=gn(e,n._repo.repoInfo_.nodeAdmin);Gs("refFromURL",t);const i=t.repoInfo;return!n._repo.repoInfo_.isCustomHost()&&i.host!==n._repo.repoInfo_.host&&X("refFromURL: Host name does not match the current database: (found "+i.host+" but expected "+n._repo.repoInfo_.host+")"),Ta(n,t.path.toString())}function xe(n,e){return n=F(n),g(n._path)===null?ea("child","path",e,!1):$n("child","path",e,!1),new K(n._repo,N(n._path,e))}function ja(n){return n=F(n),new wa(n._repo,n._path)}function $a(n,e){n=F(n),j("push",n._path),J("push",e,n._path,!0);const t=Ks(n._repo),i=Ea(t),s=xe(n,i),r=xe(n,i);let o;return e!=null?o=er(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Xa(n){return j("remove",n._path),er(n,null)}function er(n,e){n=F(n),j("set",n._path),J("set",e,n._path,!1);const t=new B;return Jn(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Ja(n,e){n=F(n),j("setPriority",n._path),jn("setPriority",e,!1);const t=new B;return Jn(n._repo,N(n._path,".priority"),e,null,t.wrapCallback(()=>{})),t.promise}function Za(n,e,t){if(j("setWithPriority",n._path),J("setWithPriority",e,n._path,!1),jn("setWithPriority",t,!1),n.key===".length"||n.key===".keys")throw"setWithPriority failed: "+n.key+" is a read-only object.";const i=new B;return Jn(n._repo,n._path,e,t,i.wrapCallback(()=>{})),i.promise}function ec(n,e){Hs("update",e,n._path,!1);const t=new B;return aa(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function tc(n){n=F(n);const e=new ti(()=>{}),t=new ot(e);return la(n._repo,n,t).then(i=>new ye(i,new K(n._repo,n._path),n._queryParams.getIndex()))}class ot{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Js("value",this,new ye(e.snapshotNode,new K(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Zs(this,e,t):null}matches(e){return e instanceof ot?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Gt{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Zs(this,e,t):null}createEvent(e,t){f(e.childName!=null,"Child events should have a childName.");const i=xe(new K(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new Js(e.type,this,new ye(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Gt?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function lt(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const a=t,c=(u,h)=>{mn(n._repo,n,l),a(u,h)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new ti(t,r||void 0),l=e==="value"?new ot(o):new Gt(e,o);return fa(n._repo,n,l),()=>mn(n._repo,n,l)}function Ia(n,e,t,i){return lt(n,"value",e,t,i)}function nc(n,e,t,i){return lt(n,"child_added",e,t,i)}function ic(n,e,t,i){return lt(n,"child_changed",e,t,i)}function sc(n,e,t,i){return lt(n,"child_moved",e,t,i)}function rc(n,e,t,i){return lt(n,"child_removed",e,t,i)}function oc(n,e,t){let i=null;const s=t?new ti(t):null;e==="value"?i=new ot(s):e&&(i=new Gt(e,s)),mn(n._repo,n,i)}class z{}class tr extends z{constructor(e,t){super(),this._value=e,this._key=t,this.type="endAt"}_apply(e){J("endAt",this._value,e._path,!0);const t=on(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function lc(n,e){return st("endAt","key",e,!0),new tr(n,e)}class Sa extends z{constructor(e,t){super(),this._value=e,this._key=t,this.type="endBefore"}_apply(e){J("endBefore",this._value,e._path,!1);const t=Wo(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasEnd())throw new Error("endBefore: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function ac(n,e){return st("endBefore","key",e,!0),new Sa(n,e)}class nr extends z{constructor(e,t){super(),this._value=e,this._key=t,this.type="startAt"}_apply(e){J("startAt",this._value,e._path,!0);const t=rn(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function cc(n=null,e){return st("startAt","key",e,!0),new nr(n,e)}class Na extends z{constructor(e,t){super(),this._value=e,this._key=t,this.type="startAfter"}_apply(e){J("startAfter",this._value,e._path,!1);const t=Fo(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasStart())throw new Error("startAfter: Starting point was already set (by another call to startAt, startAfter, or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function hc(n,e){return st("startAfter","key",e,!0),new Na(n,e)}class Ra extends z{constructor(e){super(),this._limit=e,this.type="limitToFirst"}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToFirst: Limit was already set (by another call to limitToFirst or limitToLast).");return new U(e._repo,e._path,Mo(e._queryParams,this._limit),e._orderByCalled)}}function uc(n){if(typeof n!="number"||Math.floor(n)!==n||n<=0)throw new Error("limitToFirst: First argument must be a positive integer.");return new Ra(n)}class ba extends z{constructor(e){super(),this._limit=e,this.type="limitToLast"}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new U(e._repo,e._path,Lo(e._queryParams,this._limit),e._orderByCalled)}}function dc(n){if(typeof n!="number"||Math.floor(n)!==n||n<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new ba(n)}class Pa extends z{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Vt(e,"orderByChild");const t=new E(this._path);if(y(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const i=new bn(t),s=bt(e._queryParams,i);return he(s),new U(e._repo,e._path,s,!0)}}function fc(n){if(n==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(n==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(n==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return $n("orderByChild","path",n,!1),new Pa(n)}class ka extends z{constructor(){super(...arguments),this.type="orderByKey"}_apply(e){Vt(e,"orderByKey");const t=bt(e._queryParams,$);return he(t),new U(e._repo,e._path,t,!0)}}function _c(){return new ka}class xa extends z{constructor(){super(...arguments),this.type="orderByPriority"}_apply(e){Vt(e,"orderByPriority");const t=bt(e._queryParams,S);return he(t),new U(e._repo,e._path,t,!0)}}function pc(){return new xa}class Aa extends z{constructor(){super(...arguments),this.type="orderByValue"}_apply(e){Vt(e,"orderByValue");const t=bt(e._queryParams,Pn);return he(t),new U(e._repo,e._path,t,!0)}}function mc(){return new Aa}class Da extends z{constructor(e,t){super(),this._value=e,this._key=t,this.type="equalTo"}_apply(e){if(J("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new tr(this._value,this._key)._apply(new nr(this._value,this._key)._apply(e))}}function gc(n,e){return st("equalTo","key",e,!0),new Da(n,e)}function yc(n,...e){let t=F(n);for(const i of e)t=i._apply(t);return t}Nl(K);xl(K);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oa="FIREBASE_DATABASE_EMULATOR_HOST",yn={};let ir=!1;function Ma(n,e,t,i){n.repoInfo_=new is(`${e}:${t}`,!1,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0),i&&(n.authTokenProvider_=i)}function sr(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||X("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),x("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=gn(r,s),l=o.repoInfo,a,c;typeof lr<"u"&&si&&(c=si[Oa]),c?(a=!0,r=`http://${c}?ns=${l.namespace}`,o=gn(r,s),l=o.repoInfo):a=!o.repoInfo.secure;const u=s&&a?new Se(Se.OWNER):new Ur(n.name,n.options,e);Gs("Invalid Firebase Database URL",o),y(o.path)||X("Database URL must point to the root of a Firebase Database (not including a child path).");const h=Fa(l,n,u,new Wr(n.name,t));return new Ua(h,n)}function La(n,e){const t=yn[e];(!t||t[n.key]!==n)&&X(`Database ${e}(${n.repoInfo_}) has already been deleted.`),zs(n),delete t[n.key]}function Fa(n,e,t,i){let s=yn[e.name];s||(s={},yn[e.name]=s);let r=s[n.toURLString()];return r&&X("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new sa(n,ir,t,i),s[n.toURLString()]=r,r}function Wa(n){ir=n}class Ua{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(ra(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new K(this._repo,C())),this._rootInternal}_delete(){return this._rootInternal!==null&&(La(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&X("Cannot call "+e+" on a deleted database.")}}function rr(){Ne.IS_TRANSPORT_INITIALIZED&&O("Transport has already been initialized. Please call this function before calling ref or setting up a listener")}function vc(){rr(),te.forceDisallow()}function Cc(){rr(),V.forceDisallow(),te.forceAllow()}function Ec(n=ur(),e){const t=cr(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=hr("database");i&&Ba(t,...i)}return t}function Ba(n,e,t,i={}){n=F(n),n._checkNotDeleted("useEmulator"),n._instanceStarted&&X("Cannot call useEmulator() after instance has already been initialized.");const s=n._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&X('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new Se(Se.OWNER);else if(i.mockUserToken){const o=typeof i.mockUserToken=="string"?i.mockUserToken:dr(i.mockUserToken,n.app.options.projectId);r=new Se(o)}Ma(s,e,t,r)}function wc(n){n=F(n),n._checkNotDeleted("goOffline"),zs(n._repo)}function Tc(n){n=F(n),n._checkNotDeleted("goOnline"),_a(n._repo)}function Ic(n,e){qi(n,e)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Va(n){Vi(Sr),_r(new Jt("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return sr(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),ni(ri,oi,n),ni(ri,oi,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ha={".sv":"timestamp"};function Sc(){return Ha}function Nc(n){return{".sv":{increment:n}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ga{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function Rc(n,e,t){var i;if(n=F(n),j("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const s=(i=t==null?void 0:t.applyLocally)!==null&&i!==void 0?i:!0,r=new B,o=(a,c,u)=>{let h=null;a?r.reject(a):(h=new ye(u,new K(n._repo,n._path),S),r.resolve(new Ga(c,h)))},l=Ia(n,()=>{});return pa(n._repo,n._path,e,o,l,s),r.promise}G.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};G.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};const bc=function(n){const e=G.prototype.put;return G.prototype.put=function(t,i,s,r){r!==void 0&&(r=n()),e.call(this,t,i,s,r)},function(){G.prototype.put=e}},Pc=function(n){Wa(n)};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kc({app:n,url:e,version:t,customAuthImpl:i,customAppCheckImpl:s,nodeAdmin:r=!1}){Vi(t);const o=new wr("database-standalone"),l=new ii("auth-internal",o);let a;return s&&(a=new ii("app-check-internal",o),a.setComponent(new Jt("app-check-internal",()=>s,"PRIVATE"))),l.setComponent(new Jt("auth-internal",()=>i,"PRIVATE")),sr(n,l,a,e,r)}Va();export{ye as DataSnapshot,Ua as Database,wa as OnDisconnect,z as QueryConstraint,Ga as TransactionResult,U as _QueryImpl,xn as _QueryParams,K as _ReferenceImpl,Pc as _TEST_ACCESS_forceRestClient,bc as _TEST_ACCESS_hijackHash,kc as _initStandalone,sr as _repoManagerDatabaseFromApp,Vi as _setSDKVersion,$n as _validatePathString,j as _validateWritablePath,xe as child,Ba as connectDatabaseEmulator,Ic as enableLogging,lc as endAt,ac as endBefore,gc as equalTo,Cc as forceLongPolling,vc as forceWebSockets,tc as get,Ec as getDatabase,wc as goOffline,Tc as goOnline,Nc as increment,uc as limitToFirst,dc as limitToLast,oc as off,nc as onChildAdded,ic as onChildChanged,sc as onChildMoved,rc as onChildRemoved,ja as onDisconnect,Ia as onValue,fc as orderByChild,_c as orderByKey,pc as orderByPriority,mc as orderByValue,$a as push,yc as query,Ta as ref,za as refFromURL,Xa as remove,Rc as runTransaction,Sc as serverTimestamp,er as set,Ja as setPriority,Za as setWithPriority,hc as startAfter,cc as startAt,ec as update};

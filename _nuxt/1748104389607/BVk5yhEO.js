import{g as J,a as Q,_ as $,E as Z,b as ee,D as m,L as te,i as B,c as re,d as ne,e as I,C as D,r as oe}from"./C-xxZvR6.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P(){return E().enabled}async function y(){const e=E();if(e.enabled&&e.token)return e.token.promise;throw Error(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ue(e=J(),t){e=Q(e);const r=$(e,"app-check");if(E().initialized||ve(),P()&&y().then(o=>console.log(`App Check debug token: ${o}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),r.isInitialized()){const o=r.getImmediate(),i=r.getOptions();if(i.isTokenAutoRefreshEnabled===t.isTokenAutoRefreshEnabled&&i.provider.isEqual(t.provider))return o;throw d.create("already-initialized",{appName:e.name})}const n=r.initialize({options:t});return Ke(e,t.provider,t.isTokenAutoRefreshEnabled),l(e).isTokenAutoRefreshEnabled&&G(n,"INTERNAL",()=>{}),n}function Ke(e,t,r){const n=se(e,Object.assign({},H));n.activated=!0,n.provider=t,n.cachedTokenPromise=we(e).then(o=>(o&&g(o)&&(n.token=o,X(e,{token:o.token})),o)),n.isTokenAutoRefreshEnabled=r===void 0?e.automaticDataCollectionEnabled:r,n.provider.initialize(e)}const Le="app-check",N="app-check-internal";function ze(){I(new D(Le,e=>{const t=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat");return Re(t,r)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider(N).initialize()})),I(new D(N,e=>{const t=e.getProvider("app-check").getImmediate();return Ie(t)},"PUBLIC").setInstantiationMode("EXPLICIT")),oe(De,Se)}ze();export{Y as ReCaptchaV3Provider,Ue as initializeAppCheck};

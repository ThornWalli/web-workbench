import{X as qt}from"./entry.6790753e.js";import{L as lr,I as f,J as _e,K as B,l as F,e as ar,M as cr,i as hr,N as ur,C as Zt,w as dr,O as b,P as St,Q as ut,H as en,R as Y,T as pe,f as fr,r as ii,U as si,V as Cn,W as _r,X as pr,Y as mr,Z as Wi,$ as gr,a0 as yr,x as Ui,y as vr,q as Cr,a1 as Er,a2 as wr,a3 as Tr,a4 as Xe,S as Ir}from"./index.esm2017.200f3402.js";const ri="@firebase/database",oi="1.0.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hi=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Sr(e)}}catch{}return new Nr},de=Hi("localStorage"),tn=Hi("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wn="5",zi="v",ji="s",$i="r",Xi="f",Ji=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Zi="ls",es="p",sn="ac",ts="websocket",ns="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yt={},Kt={};function Tn(n){const e=n.toString();return Yt[e]||(Yt[e]=new Br),Yt[e]}function Vr(n,e){const t=n.toString();return Kt[t]||(Kt[t]=e()),Kt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn extends us{constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}static getInstance(){return new Rn}getInitialEvent(e){return f(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eo(n,e){return ve(n.name,e.name)}function bn(n,e){return ve(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rn;function wo(n){rn=n}const ps=function(n){return typeof n=="number"?"number:"+Ki(n):"string:"+n},ms=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Y(e,".sv"),"Priority must be a string or number.")}else f(n===rn||n.isEmpty(),"priority of unexpected type.");f(n===rn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko extends Rt{compare(e,t){const i=e.node.compareTo(t.node);return i===0?ve(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return v.MIN}maxPost(){return v.MAX}makePost(e,t){const i=R(e);return new v(t,i)}toString(){return".value"}}const kn=new ko;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xn{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){f(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(s).equals(i.getChild(s))&&l.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(qe(t,l)):f(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(Re(t,i)):o.trackChildChange(Ye(t,i,l))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(S,(s,r)=>{t.hasChild(s)||i.trackChildChange(qe(s,r))}),t.isLeafNode()||t.forEachChild(S,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(Ye(s,r,o))}else i.trackChildChange(Re(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?m.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mt(){return{value:null,children:new Map}}function De(n,e,t){if(y(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=g(e);n.children.has(i)||n.children.set(i,mt());const s=n.children.get(i);e=T(e),De(s,e,t)}}function an(n,e){if(y(e))return n.value=null,n.children.clear(),!0;if(n.value!==null){if(n.value.isLeafNode())return!1;{const t=n.value;return n.value=null,t.forEachChild(S,(i,s)=>{De(n,new E(i),s)}),an(n,e)}}else if(n.children.size>0){const t=g(e);return e=T(e),n.children.has(t)&&an(n.children.get(t),e)&&n.children.delete(t),n.children.size===0}else return!0}function cn(n,e,t){n.value!==null?t(e,n.value):Uo(n,(i,s)=>{const r=new E(e.toString()+"/"+i);cn(s,r,t)})}function Uo(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ti=10*1e3,Vo=30*1e3,Ho=5*60*1e3;class Go{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Bo(e);const i=Ti+(Vo-Ti)*Math.random();Be(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;A(e,(s,r)=>{r>0&&Y(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Be(this.reportStats_.bind(this),Math.floor(Math.random()*2*Ho))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Q;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Q||(Q={}));function Dn(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function On(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Mn(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=Q.ACK_USER_WRITE,this.source=Dn()}operationForChild(e){if(y(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new E(e));return new gt(C(),t,this.revert)}}else return f(g(this.path)===e,"operationForChild called for unrelated child."),new gt(T(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(n,e){return Ss(e,n)}function jo(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=He(n.visibleWrites,e,t)),n.lastWriteId=i}function $o(n,e,t,i){f(i>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:i,visible:!0}),n.visibleWrites=hn(n.visibleWrites,e,t),n.lastWriteId=i}function Xo(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function Jo(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&Zo(l,i.path)?s=!1:H(i.path,l.path)&&(r=!0)),o--}if(s){if(r)return el(n),!0;if(i.snap)n.visibleWrites=Ii(n.visibleWrites,i.path);else{const l=i.children;A(l,a=>{n.visibleWrites=Ii(n.visibleWrites,N(i.path,a))})}return!0}else return!1}function Zo(n,e){if(n.snap)return H(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&H(N(n.path,t),e))return!0;return!1}function el(n){n.visibleWrites=ws(n.allWrites,tl,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function tl(n){return n.visible}function ws(n,e,t){let i=q.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let l;if(r.snap)H(t,o)?(l=M(t,o),i=He(i,l,r.snap)):H(o,t)&&(l=M(o,t),i=He(i,C(),r.snap.getChild(l)));else if(r.children){if(H(t,o))l=M(t,o),i=hn(i,l,r.children);else if(H(o,t))if(l=M(o,t),y(l))i=hn(i,C(),r.children);else{const a=pe(r.children,g(l));if(a){const c=a.getChild(T(l));i=He(i,C(),c)}}}else throw Xe("WriteRecord should have .snap or .children")}}return i}function Ts(n,e,t,i,s){if(!i&&!s){const r=Ce(n.visibleWrites,e);if(r!=null)return r;{const o=ie(n.visibleWrites,e);if(dn(o))return t;if(t==null&&!un(o,C()))return null;{const l=t||m.EMPTY_NODE;return Pe(o,l)}}}else{const r=ie(n.visibleWrites,e);if(!s&&dn(r))return t;if(!s&&t==null&&!un(r,C()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(H(c.path,e)||H(e,c.path))},l=ws(n.allWrites,o,e),a=t||m.EMPTY_NODE;return Pe(l,a)}}}function nl(n,e,t){let i=m.EMPTY_NODE;const s=Ce(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(S,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=ie(n.visibleWrites,e);return t.forEachChild(S,(o,l)=>{const a=Pe(ie(r,new E(o)),l);i=i.updateImmediateChild(o,a)}),Si(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ie(n.visibleWrites,e);return Si(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function il(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=N(e,t);if(un(n.visibleWrites,r))return null;{const o=ie(n.visibleWrites,r);return dn(o)?s.getChild(t):Pe(o,s.getChild(t))}}function sl(n,e,t,i){const s=N(e,t),r=Ce(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=ie(n.visibleWrites,s);return Pe(o,i.getNode().getImmediateChild(t))}else return null}function rl(n,e){return Ce(n.visibleWrites,e)}function ol(n,e,t,i,s,r,o){let l;const a=ie(n.visibleWrites,e),c=Ce(a,C());if(c!=null)l=c;else if(t!=null)l=Pe(a,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=o.getCompare(),d=r?l.getReverseIteratorFrom(i,o):l.getIteratorFrom(i,o);let _=d.getNext();for(;_&&u.length<s;)h(_,i)!==0&&u.push(_),_=d.getNext();return u}else return[]}function ll(){return{visibleWrites:q.empty(),allWrites:[],lastWriteId:-1}}function vt(n,e,t,i){return Ts(n.writeTree,n.treePath,e,t,i)}function Ln(n,e){return nl(n.writeTree,n.treePath,e)}function Ni(n,e,t,i){return il(n.writeTree,n.treePath,e,t,i)}function Ct(n,e){return rl(n.writeTree,N(n.treePath,e))}function al(n,e,t,i,s,r){return ol(n.writeTree,n.treePath,e,t,i,s,r)}function Fn(n,e,t){return sl(n.writeTree,n.treePath,e,t)}function Is(n,e){return Ss(N(n.treePath,e),n.writeTree)}function Ss(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hl{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Ns=new hl;class Wn{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new le(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Fn(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ge(this.viewCache_),r=al(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ul(n){return{filter:n}}function dl(n,e){f(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),f(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function fl(n,e,t,i,s){const r=new cl;let o,l;if(t.type===Q.OVERWRITE){const c=t;c.source.fromUser?o=fn(n,e,c.path,c.snap,i,s,r):(f(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered()&&!y(c.path),o=Et(n,e,c.path,c.snap,i,s,l,r))}else if(t.type===Q.MERGE){const c=t;c.source.fromUser?o=pl(n,e,c.path,c.children,i,s,r):(f(c.source.fromServer,"Unknown source."),l=c.source.tagged||e.serverCache.isFiltered(),o=_n(n,e,c.path,c.children,i,s,l,r))}else if(t.type===Q.ACK_USER_WRITE){const c=t;c.revert?o=yl(n,e,c.path,i,s,r):o=ml(n,e,c.path,c.affectedTree,i,s,r)}else if(t.type===Q.LISTEN_COMPLETE)o=gl(n,e,t.path,i,r);else throw Xe("Unknown operation type: "+t.type);const a=r.getChanges();return _l(e,o,a),{viewCache:o,changes:a}}function _l(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=yt(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(vs(yt(e)))}}function Rs(n,e,t,i,s,r){const o=e.eventCache;if(Ct(i,t)!=null)return e;{let l,a;if(y(t))if(f(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=ge(e),u=c instanceof m?c:m.EMPTY_NODE,h=Ln(i,u);l=n.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=vt(i,ge(e));l=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=g(t);if(c===".priority"){f(oe(t)===1,"Can't have a priority with additional path components");const u=o.getNode();a=e.serverCache.getNode();const h=Ni(i,t,u,a);h!=null?l=n.filter.updatePriority(u,h):l=o.getNode()}else{const u=T(t);let h;if(o.isCompleteForChild(c)){a=e.serverCache.getNode();const d=Ni(i,t,o.getNode(),a);d!=null?h=o.getNode().getImmediateChild(c).updateChild(u,d):h=o.getNode().getImmediateChild(c)}else h=Fn(i,c,e.serverCache);h!=null?l=n.filter.updateChild(o.getNode(),c,h,u,s,r):l=o.getNode()}}return Ve(e,l,o.isFullyInitialized()||y(t),n.filter.filtersNodes())}}function Et(n,e,t,i,s,r,o,l){const a=e.serverCache;let c;const u=o?n.filter:n.filter.getIndexedFilter();if(y(t))c=u.updateFullNode(a.getNode(),i,null);else if(u.filtersNodes()&&!a.isFiltered()){const _=a.getNode().updateChild(t,i);c=u.updateFullNode(a.getNode(),_,null)}else{const _=g(t);if(!a.isCompleteForPath(t)&&oe(t)>1)return e;const p=T(t),D=a.getNode().getImmediateChild(_).updateChild(p,i);_===".priority"?c=u.updatePriority(a.getNode(),D):c=u.updateChild(a.getNode(),_,D,p,Ns,null)}const h=Cs(e,c,a.isFullyInitialized()||y(t),u.filtersNodes()),d=new Wn(s,h,r);return Rs(n,h,t,s,d,l)}function fn(n,e,t,i,s,r,o){const l=e.eventCache;let a,c;const u=new Wn(s,e,r);if(y(t))c=n.filter.updateFullNode(e.eventCache.getNode(),i,o),a=Ve(e,c,!0,n.filter.filtersNodes());else{const h=g(t);if(h===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),i),a=Ve(e,c,l.isFullyInitialized(),l.isFiltered());else{const d=T(t),_=l.getNode().getImmediateChild(h);let p;if(y(d))p=i;else{const w=u.getCompleteChild(h);w!=null?Sn(d)===".priority"&&w.getChild(ds(d)).isEmpty()?p=w:p=w.updateChild(d,i):p=m.EMPTY_NODE}if(_.equals(p))a=e;else{const w=n.filter.updateChild(l.getNode(),h,p,d,u,o);a=Ve(e,w,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function Ri(n,e){return n.eventCache.isCompleteForChild(e)}function pl(n,e,t,i,s,r,o){let l=e;return i.foreach((a,c)=>{const u=N(t,a);Ri(e,g(u))&&(l=fn(n,l,u,c,s,r,o))}),i.foreach((a,c)=>{const u=N(t,a);Ri(e,g(u))||(l=fn(n,l,u,c,s,r,o))}),l}function bi(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function _n(n,e,t,i,s,r,o,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,c;y(t)?c=i:c=new I(null).setTree(t,i);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const _=e.serverCache.getNode().getImmediateChild(h),p=bi(n,_,d);a=Et(n,a,new E(h),p,s,r,o,l)}}),c.children.inorderTraversal((h,d)=>{const _=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!_){const p=e.serverCache.getNode().getImmediateChild(h),w=bi(n,p,d);a=Et(n,a,new E(h),w,s,r,o,l)}}),a}function ml(n,e,t,i,s,r,o){if(Ct(s,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(i.value!=null){if(y(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return Et(n,e,t,a.getNode().getChild(t),s,r,l,o);if(y(t)){let c=new I(null);return a.getNode().forEachChild($,(u,h)=>{c=c.set(new E(u),h)}),_n(n,e,t,c,s,r,l,o)}else return e}else{let c=new I(null);return i.foreach((u,h)=>{const d=N(t,u);a.isCompleteForPath(d)&&(c=c.set(u,a.getNode().getChild(d)))}),_n(n,e,t,c,s,r,l,o)}}function gl(n,e,t,i,s){const r=e.serverCache,o=Cs(e,r.getNode(),r.isFullyInitialized()||y(t),r.isFiltered());return Rs(n,o,t,i,Ns,s)}function yl(n,e,t,i,s,r){let o;if(Ct(i,t)!=null)return e;{const l=new Wn(i,e,s),a=e.eventCache.getNode();let c;if(y(t)||g(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=vt(i,ge(e));else{const h=e.serverCache.getNode();f(h instanceof m,"serverChildren would be complete if leaf node"),u=Ln(i,h)}u=u,c=n.filter.updateFullNode(a,u,r)}else{const u=g(t);let h=Fn(i,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?c=n.filter.updateChild(a,u,h,T(t),l,r):e.eventCache.getNode().hasChild(u)?c=n.filter.updateChild(a,u,m.EMPTY_NODE,T(t),l,r):c=a,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=vt(i,ge(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||Ct(i,C())!=null,Ve(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tt;function kl(n){f(!Tt,"__referenceConstructor has already been defined"),Tt=n}function xl(){return f(Tt,"Reference.ts has not been loaded"),Tt}let Al=1;class Ai{constructor(e){this.listenProvider_=e,this.syncPointTree_=new I(null),this.pendingWriteTree_=ll(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Bn(n,e,t,i,s){return jo(n.pendingWriteTree_,e,t,i,s),s?Oe(n,new me(Dn(),e,t)):[]}function Dl(n,e,t,i){$o(n.pendingWriteTree_,e,t,i);const s=I.fromObject(t);return Oe(n,new be(Dn(),e,s))}function ne(n,e,t=!1){const i=Xo(n.pendingWriteTree_,e);if(Jo(n.pendingWriteTree_,e)){let r=new I(null);return i.snap!=null?r=r.set(C(),!0):A(i.children,o=>{r=r.set(new E(o),!0)}),Oe(n,new gt(i.path,r,t))}else return[]}function tt(n,e,t){return Oe(n,new me(On(),e,t))}function Ol(n,e,t){const i=I.fromObject(t);return Oe(n,new be(On(),e,i))}function Ml(n,e){return Oe(n,new ze(On(),e))}function Ll(n,e,t){const i=Vn(n,t);if(i){const s=Hn(i),r=s.path,o=s.queryId,l=M(r,e),a=new ze(Mn(o),l);return Gn(n,r,a)}else return[]}function It(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Ds(o,e))){const a=Pl(o,e,t,i);Rl(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!s){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,_)=>ae(_));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=Ul(d);for(let p=0;p<_.length;++p){const w=_[p],D=w.query,we=Fs(n,w);n.listenProvider_.startListening(Ge(D),je(n,D),we.hashFn,we.onComplete)}}}!h&&c.length>0&&!i&&(u?n.listenProvider_.stopListening(Ge(e),null):c.forEach(d=>{const _=n.queryToTagMap.get(Dt(d));n.listenProvider_.stopListening(Ge(d),_)}))}Bl(n,c)}return l}function Os(n,e,t,i){const s=Vn(n,i);if(s!=null){const r=Hn(s),o=r.path,l=r.queryId,a=M(o,e),c=new me(Mn(l),a,t);return Gn(n,o,c)}else return[]}function Fl(n,e,t,i){const s=Vn(n,i);if(s){const r=Hn(s),o=r.path,l=r.queryId,a=M(o,e),c=I.fromObject(t),u=new be(Mn(l),a,c);return Gn(n,o,u)}else return[]}function pn(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,_)=>{const p=M(d,s);r=r||se(_,p),o=o||ae(_)});let l=n.syncPointTree_.get(s);l?(o=o||ae(l),r=r||se(l,C())):(l=new Ps,n.syncPointTree_=n.syncPointTree_.set(s,l));let a;r!=null?a=!0:(a=!1,r=m.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((_,p)=>{const w=se(p,C());w&&(r=r.updateImmediateChild(_,w))}));const c=Ds(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=Dt(e);f(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=Vl();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const u=kt(n.pendingWriteTree_,s);let h=bl(l,e,t,u,r,a);if(!c&&!o&&!i){const d=As(l,e);h=h.concat(Hl(n,e,d))}return h}function At(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const a=M(o,e),c=se(l,a);if(c)return c});return Ts(s,e,r,t,!0)}function Wl(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(c,u)=>{const h=M(c,t);i=i||se(u,h)});let s=n.syncPointTree_.get(t);s?i=i||se(s,C()):(s=new Ps,n.syncPointTree_=n.syncPointTree_.set(t,s));const r=i!=null,o=r?new le(i,!0,!1):null,l=kt(n.pendingWriteTree_,e._path),a=ks(s,e,l,r?o.getNode():m.EMPTY_NODE,r);return El(a)}function Oe(n,e){return Ms(e,n.syncPointTree_,null,kt(n.pendingWriteTree_,C()))}function Ms(n,e,t,i){if(y(n.path))return Ls(n,e,t,i);{const s=e.get(C());t==null&&s!=null&&(t=se(s,C()));let r=[];const o=g(n.path),l=n.operationForChild(o),a=e.children.get(o);if(a&&l){const c=t?t.getImmediateChild(o):null,u=Is(i,o);r=r.concat(Ms(l,a,c,u))}return s&&(r=r.concat(Un(s,n,i,t))),r}}function Ls(n,e,t,i){const s=e.get(C());t==null&&s!=null&&(t=se(s,C()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=t?t.getImmediateChild(o):null,c=Is(i,o),u=n.operationForChild(o);u&&(r=r.concat(Ls(u,l,a,c)))}),s&&(r=r.concat(Un(s,n,i,t))),r}function Fs(n,e){const t=e.query,i=je(n,t);return{hashFn:()=>(Cl(e)||m.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Ll(n,t._path,i):Ml(n,t._path);{const r=Ar(s,t);return It(n,t,null,r)}}}}function je(n,e){const t=Dt(e);return n.queryToTagMap.get(t)}function Dt(n){return n._path.toString()+"$"+n._queryIdentifier}function Vn(n,e){return n.tagToQueryMap.get(e)}function Hn(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new E(n.substr(0,e))}}function Gn(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=kt(n.pendingWriteTree_,e);return Un(i,t,s,null)}function Ul(n){return n.fold((e,t,i)=>{if(t&&ae(t))return[xt(t)];{let s=[];return t&&(s=xs(t)),A(i,(r,o)=>{s=s.concat(o)}),s}})}function Ge(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(xl())(n._repo,n._path):n}function Bl(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=Dt(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function Vl(){return Al++}function Hl(n,e,t){const i=e._path,s=je(n,e),r=Fs(n,t),o=n.listenProvider_.startListening(Ge(e),s,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(i);if(s)f(!ae(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,u,h)=>{if(!y(c)&&u&&ae(u))return[xt(u).query];{let d=[];return u&&(d=d.concat(xs(u).map(_=>_.query))),A(h,(_,p)=>{d=d.concat(p)}),d}});for(let c=0;c<a.length;++c){const u=a[c];n.listenProvider_.stopListening(Ge(u),je(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e="",t=null,i={children:{},childCount:0}){this.name=e,this.parent=t,this.node=i}}function Ot(n,e){let t=e instanceof E?e:new E(e),i=n,s=g(t);for(;s!==null;){const r=pe(i.node.children,s)||{children:{},childCount:0};i=new zn(s,i,r),t=T(t),s=g(t)}return i}function Ee(n){return n.node.value}function jn(n,e){n.node.value=e,mn(n)}function Us(n){return n.node.childCount>0}function Yl(n){return Ee(n)===void 0&&!Us(n)}function Mt(n,e){A(n.node.children,(t,i)=>{e(new zn(t,n,i))})}function Bs(n,e,t,i){t&&!i&&e(n),Mt(n,s=>{Bs(s,e,!0,i)}),t&&i&&e(n)}function Kl(n,e,t){let i=t?n:n.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function nt(n){return new E(n.parent===null?n.name:nt(n.parent)+"/"+n.name)}function mn(n){n.parent!==null&&zl(n.parent,n.name,n)}function zl(n,e,t){const i=Yl(t),s=Y(n.node.children,e);i&&s?(delete n.node.children[e],n.node.childCount--,mn(n)):!i&&!s&&(n.node.children[e]=t.node,n.node.childCount++,mn(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jl=/[\[\].#$\/\u0000-\u001F\u007F]/,$l=/[\[\].#$\u0000-\u001F\u007F]/,Xt=10*1024*1024,Lt=function(n){return typeof n=="string"&&n.length!==0&&!jl.test(n)},Vs=function(n){return typeof n=="string"&&n.length!==0&&!$l.test(n)},Xl=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Vs(n)},$e=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Nt(n)||n&&typeof n=="object"&&Y(n,".sv")},J=function(n,e,t,i){i&&e===void 0||it(_e(n,"value"),e,t)},it=function(n,e,t){const i=t instanceof E?new fo(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+ue(i));if(typeof e=="function")throw new Error(n+"contains a function "+ue(i)+" with contents = "+e.toString());if(Nt(e))throw new Error(n+"contains "+e.toString()+" "+ue(i));if(typeof e=="string"&&e.length>Xt/3&&St(e)>Xt)throw new Error(n+"contains a string greater than "+Xt+" utf8 bytes "+ue(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(A(e,(o,l)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Lt(o)))throw new Error(n+" contains an invalid key ("+o+") "+ue(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);_o(i,o),it(n,l,i),po(i)}),s&&r)throw new Error(n+' contains ".value" child '+ue(i)+" in addition to actual children.")}},Jl=function(n,e){let t,i;for(t=0;t<e.length;t++){i=e[t];const r=Qe(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Lt(r[o]))throw new Error(n+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(uo);let s=null;for(t=0;t<e.length;t++){if(i=e[t],s!==null&&H(s,i))throw new Error(n+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Hs=function(n,e,t,i){if(i&&e===void 0)return;const s=_e(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];A(e,(o,l)=>{const a=new E(o);if(it(s,l,N(t,a)),Sn(a)===".priority"&&!$e(l))throw new Error(s+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(a)}),Jl(s,r)},$n=function(n,e,t){if(!(t&&e===void 0)){if(Nt(e))throw new Error(_e(n,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!$e(e))throw new Error(_e(n,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")}},st=function(n,e,t,i){if(!(i&&t===void 0)&&!Lt(t))throw new Error(_e(n,e)+'was an invalid key = "'+t+`".  Firebase keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]").`)},Xn=function(n,e,t,i){if(!(i&&t===void 0)&&!Vs(t))throw new Error(_e(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Zl=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Xn(n,e,t,i)},j=function(n,e){if(g(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Gs=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Lt(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Xl(t))throw new Error(_e(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ea{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ft(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Nn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function Qs(n,e,t){Ft(n,t),qs(n,i=>Nn(i,e))}function W(n,e,t){Ft(n,t),qs(n,i=>H(i,e)||H(e,i))}function qs(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(ta(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function ta(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();fe&&x("event: "+t.toString()),Ae(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return y(this._path)?null:Sn(this._path)}get ref(){return new K(this._repo,this._path)}get _queryIdentifier(){const e=wi(this._queryParams),t=En(e);return t==="{}"?"default":t}get _queryObject(){return wi(this._queryParams)}isEqual(e){if(e=F(e),!(e instanceof U))return!1;const t=this._repo===e._repo,i=Nn(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+ho(this._path)}}function Vt(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function he(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===$){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",s="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==re)throw new Error(i);if(typeof e!="string")throw new Error(s)}if(n.hasEnd()){if(n.getIndexEndName()!==ee)throw new Error(i);if(typeof t!="string")throw new Error(s)}}else if(n.getIndex()===S){if(e!=null&&!$e(e)||t!=null&&!$e(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(f(n.getIndex()instanceof Pn||n.getIndex()===kn,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function Ht(n){if(n.hasStart()&&n.hasEnd()&&n.hasLimit()&&!n.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class K extends U{constructor(e,t){super(e,t,new An,!1)}get parent(){const e=ds(this._path);return e===null?null:new K(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ye{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new E(e),i=xe(this.ref,e);return new ye(this._node.getChild(t),i,S)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new ye(s,xe(this.ref,i),S)))}hasChild(e){const t=new E(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function wa(n,e){return n=F(n),n._checkNotDeleted("ref"),e!==void 0?xe(n._root,e):n._root}function qa(n,e){n=F(n),n._checkNotDeleted("refFromURL");const t=yn(e,n._repo.repoInfo_.nodeAdmin);Gs("refFromURL",t);const i=t.repoInfo;return!n._repo.repoInfo_.isCustomHost()&&i.host!==n._repo.repoInfo_.host&&X("refFromURL: Host name does not match the current database: (found "+i.host+" but expected "+n._repo.repoInfo_.host+")"),wa(n,t.path.toString())}function xe(n,e){return n=F(n),g(n._path)===null?Zl("child","path",e,!1):Xn("child","path",e,!1),new K(n._repo,N(n._path,e))}function Ya(n){return n=F(n),new Ea(n._repo,n._path)}function Ka(n,e){n=F(n),j("push",n._path),J("push",e,n._path,!0);const t=Ks(n._repo),i=Ca(t),s=xe(n,i),r=xe(n,i);let o;return e!=null?o=er(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function za(n){return j("remove",n._path),er(n,null)}function er(n,e){n=F(n),j("set",n._path),J("set",e,n._path,!1);const t=new B;return Zn(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ja(n,e){n=F(n),j("setPriority",n._path),$n("setPriority",e,!1);const t=new B;return Zn(n._repo,N(n._path,".priority"),e,null,t.wrapCallback(()=>{})),t.promise}function $a(n,e,t){if(j("setWithPriority",n._path),J("setWithPriority",e,n._path,!1),$n("setWithPriority",t,!1),n.key===".length"||n.key===".keys")throw"setWithPriority failed: "+n.key+" is a read-only object.";const i=new B;return Zn(n._repo,n._path,e,t,i.wrapCallback(()=>{})),i.promise}function Xa(n,e){Hs("update",e,n._path,!1);const t=new B;return la(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}function Ja(n){n=F(n);const e=new ni(()=>{}),t=new ot(e);return oa(n._repo,n,t).then(i=>new ye(i,new K(n._repo,n._path),n._queryParams.getIndex()))}class ot{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Js("value",this,new ye(e.snapshotNode,new K(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Zs(this,e,t):null}matches(e){return e instanceof ot?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class Gt{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Zs(this,e,t):null}createEvent(e,t){f(e.childName!=null,"Child events should have a childName.");const i=xe(new K(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new Js(e.type,this,new ye(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Gt?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function lt(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const a=t,c=(u,h)=>{gn(n._repo,n,l),a(u,h)};c.userCallback=t.userCallback,c.context=t.context,t=c}const o=new ni(t,r||void 0),l=e==="value"?new ot(o):new Gt(e,o);return da(n._repo,n,l),()=>gn(n._repo,n,l)}function Ta(n,e,t,i){return lt(n,"value",e,t,i)}function Za(n,e,t,i){return lt(n,"child_added",e,t,i)}function ec(n,e,t,i){return lt(n,"child_changed",e,t,i)}function tc(n,e,t,i){return lt(n,"child_moved",e,t,i)}function nc(n,e,t,i){return lt(n,"child_removed",e,t,i)}function ic(n,e,t){let i=null;const s=t?new ni(t):null;e==="value"?i=new ot(s):e&&(i=new Gt(e,s)),gn(n._repo,n,i)}class z{}class tr extends z{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){J("endAt",this._value,e._path,!0);const t=ln(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function sc(n,e){return st("endAt","key",e,!0),new tr(n,e)}class Ia extends z{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){J("endBefore",this._value,e._path,!1);const t=Fo(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasEnd())throw new Error("endBefore: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function rc(n,e){return st("endBefore","key",e,!0),new Ia(n,e)}class nr extends z{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){J("startAt",this._value,e._path,!0);const t=on(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function oc(n=null,e){return st("startAt","key",e,!0),new nr(n,e)}class Sa extends z{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){J("startAfter",this._value,e._path,!1);const t=Lo(e._queryParams,this._value,this._key);if(Ht(t),he(t),e._queryParams.hasStart())throw new Error("startAfter: Starting point was already set (by another call to startAt, startAfter, or equalTo).");return new U(e._repo,e._path,t,e._orderByCalled)}}function lc(n,e){return st("startAfter","key",e,!0),new Sa(n,e)}class Na extends z{constructor(e){super(),this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToFirst: Limit was already set (by another call to limitToFirst or limitToLast).");return new U(e._repo,e._path,Oo(e._queryParams,this._limit),e._orderByCalled)}}function ac(n){if(typeof n!="number"||Math.floor(n)!==n||n<=0)throw new Error("limitToFirst: First argument must be a positive integer.");return new Na(n)}class Ra extends z{constructor(e){super(),this._limit=e}_apply(e){if(e._queryParams.hasLimit())throw new Error("limitToLast: Limit was already set (by another call to limitToFirst or limitToLast).");return new U(e._repo,e._path,Mo(e._queryParams,this._limit),e._orderByCalled)}}function cc(n){if(typeof n!="number"||Math.floor(n)!==n||n<=0)throw new Error("limitToLast: First argument must be a positive integer.");return new Ra(n)}class ba extends z{constructor(e){super(),this._path=e}_apply(e){Vt(e,"orderByChild");const t=new E(this._path);if(y(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const i=new Pn(t),s=bt(e._queryParams,i);return he(s),new U(e._repo,e._path,s,!0)}}function hc(n){if(n==="$key")throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if(n==="$priority")throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if(n==="$value")throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return Xn("orderByChild","path",n,!1),new ba(n)}class Pa extends z{_apply(e){Vt(e,"orderByKey");const t=bt(e._queryParams,$);return he(t),new U(e._repo,e._path,t,!0)}}function uc(){return new Pa}class ka extends z{_apply(e){Vt(e,"orderByPriority");const t=bt(e._queryParams,S);return he(t),new U(e._repo,e._path,t,!0)}}function dc(){return new ka}class xa extends z{_apply(e){Vt(e,"orderByValue");const t=bt(e._queryParams,kn);return he(t),new U(e._repo,e._path,t,!0)}}function fc(){return new xa}class Aa extends z{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){if(J("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new tr(this._value,this._key)._apply(new nr(this._value,this._key)._apply(e))}}function _c(n,e){return st("equalTo","key",e,!0),new Aa(n,e)}function pc(n,...e){let t=F(n);for(const i of e)t=i._apply(t);return t}Sl(K);kl(K);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ba(n){Vi(Ir),fr(new Zt("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return sr(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),ii(ri,oi,n),ii(ri,oi,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Va={".sv":"timestamp"};function wc(){return Va}function Tc(n){return{".sv":{increment:n}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ha{constructor(e,t){this.committed=e,this.snapshot=t}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function Ic(n,e,t){var i;if(n=F(n),j("Reference.transaction",n._path),n.key===".length"||n.key===".keys")throw"Reference.transaction failed: "+n.key+" is a read-only object.";const s=(i=t==null?void 0:t.applyLocally)!==null&&i!==void 0?i:!0,r=new B,o=(a,c,u)=>{let h=null;a?r.reject(a):(h=new ye(u,new K(n._repo,n._path),S),r.resolve(new Ha(c,h)))},l=Ta(n,()=>{});return _a(n._repo,n._path,e,o,l,s),r.promise}G.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};G.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};const Sc=function(n){const e=G.prototype.put;return G.prototype.put=function(t,i,s,r){r!==void 0&&(r=n()),e.call(this,t,i,s,r)},function(){G.prototype.put=e}},Nc=function(n){Fa(n)};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rc({app:n,url:e,version:t,customAuthImpl:i,customAppCheckImpl:s,nodeAdmin:r=!1}){Vi(t);const o=new Er("database-standalone"),l=new si("auth-internal",o);let a;return s&&(a=new si("app-check-internal",o),a.setComponent(new Zt("app-check-internal",()=>s,"PRIVATE"))),l.setComponent(new Zt("auth-internal",()=>i,"PRIVATE")),sr(n,l,a,e,r)}Ba();export{ye as DataSnapshot,Wa as Database,Ea as OnDisconnect,z as QueryConstraint,Ha as TransactionResult,U as _QueryImpl,An as _QueryParams,K as _ReferenceImpl,Nc as _TEST_ACCESS_forceRestClient,Sc as _TEST_ACCESS_hijackHash,Rc as _initStandalone,sr as _repoManagerDatabaseFromApp,Vi as _setSDKVersion,Xn as _validatePathString,j as _validateWritablePath,xe as child,Ua as connectDatabaseEmulator,Ec as enableLogging,sc as endAt,rc as endBefore,_c as equalTo,gc as forceLongPolling,mc as forceWebSockets,Ja as get,yc as getDatabase,vc as goOffline,Cc as goOnline,Tc as increment,ac as limitToFirst,cc as limitToLast,ic as off,Za as onChildAdded,ec as onChildChanged,tc as onChildMoved,nc as onChildRemoved,Ya as onDisconnect,Ta as onValue,hc as orderByChild,uc as orderByKey,dc as orderByPriority,fc as orderByValue,Ka as push,pc as query,wa as ref,qa as refFromURL,za as remove,Ic as runTransaction,wc as serverTimestamp,er as set,ja as setPriority,$a as setWithPriority,lc as startAfter,oc as startAt,Xa as update};

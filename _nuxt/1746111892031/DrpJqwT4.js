import{k as o}from"./C5mdboMC.js";import{u as s}from"./DoGjLmTD.js";import{r as f}from"./DoVacF4u.js";const e=f([]);function c(){const r=t=>{t=t.filter(n=>!e.value.find(a=>a.fontFamily===n.fontFamily)),e.value=[...e.value,...t]};return s(()=>({link:e.value.filter(t=>t.preload).map(t=>({key:`preload-${o(t.fontFamily)}`,rel:"preload",as:"font",href:t.src[0],type:`font/${t.src[1]}`,crossorigin:"anonymous"})),style:[{key:"fonts",innerHTML:i(e.value)}]})),{registerFont:r}}function i(r){return r.map(t=>`
@font-face {

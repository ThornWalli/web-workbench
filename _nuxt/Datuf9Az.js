import{g as J,a as Q,_ as $,E as Z,b as ee,D as m,L as te,i as B,c as re,d as ne,e as I,C as D,r as oe}from"./BAgKhQxM.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Re{constructor(t,r){this.app=t,this.heartbeatServiceProvider=r}_delete(){const{tokenObservers:t}=l(this.app);for(const r of t)V(this.app,r.next);return Promise.resolve()}}function ye(e,t){return new Re(e,t)}function Ie(e){return{getToken:t=>A(e,t),getLimitedUseToken:()=>Ce(e),addTokenListener:t=>G(e,"INTERNAL",t),removeTokenListener:t=>V(e.app,t)}}const De="@firebase/app-check",Se="0.10.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

import{ah as U}from"./CGxhFLb4.js";import{X as be}from"./D2Od5ZZC.js";var V={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(st(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function st(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const A="@firebase/app",x="0.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g=new Ue("@firebase/app"),it="@firebase/app-compat",ot="@firebase/analytics-compat",at="@firebase/analytics",ct="@firebase/app-check-compat",lt="@firebase/app-check",ht="@firebase/auth",dt="@firebase/auth-compat",ft="@firebase/database",ut="@firebase/database-compat",pt="@firebase/functions",mt="@firebase/functions-compat",bt="@firebase/installations",gt="@firebase/installations-compat",_t="@firebase/messaging",yt="@firebase/messaging-compat",vt="@firebase/performance",Et="@firebase/performance-compat",wt="@firebase/remote-config",Dt="@firebase/remote-config-compat",It="@firebase/storage",St="@firebase/storage-compat",Ct="@firebase/firestore",At="@firebase/firestore-compat",Ot="firebase",Bt="10.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wt(t){H(new C("platform-logger",e=>new rt(e),"PRIVATE")),H(new C("heartbeat",e=>new zt(e),"PRIVATE")),I(A,x,t),I(A,x,"esm2017"),I("fire-js","")}Wt("");export{gn as $,d as A,Qt as B,en as C,O as D,C as E,w as F,oe as G,Zt as H,ie as I,tn as J,mn as K,Ue as L,ln as M,ge as N,bn as O,Oe as P,Yt as Q,qt as R,In as S,rn as T,_n as U,hn as V,an as W,cn as X,ke as Y,W as Z,X as _,vn as a,pn as a0,ne as a1,nn as a2,on as a3,sn as a4,ce as a5,Kt as a6,Ee as a7,_e as a8,_ as b,Dn as c,v as d,Tt as e,Rt as f,wn as g,H as h,En as i,y as j,Pt as k,Cn as l,An as m,Lt as n,Sn as o,On as p,yn as q,I as r,Bn as s,$ as t,L as u,dn as v,fn as w,un as x,Xt as y,Ae as z};
